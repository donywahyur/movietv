...
void main() {
  ...
  group('get Now Playing Tvs', () {
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      // assert
      // print(readJson('dummy_data/tv_now_playing.json'));
      // print(tTvList.toList().toString());
  ...
  group('search Tvs', () {
    final tSearchResult = TvResponse.fromJson(
            json.decode(readJson('dummy_data/tv_search_arcane.json')))
        .tvList;
    final tQuery = 'arcane';
    ...
    test('should return list of Tvs when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tv_search_arcane.json'), 200));
      // act
